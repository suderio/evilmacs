...
- [[#important-things-to-do-first][IMPORTANT THINGS TO DO FIRST]]
  ...
  - [[#app-launcher-this-is-still-not-working-very-well][App Launcher (this is still not working very well)]]
...
After the (amazing) Doom emacs breaks for the 59th time, I realized I would need to start my own configuration from the ground up. This is it.
...
** App Launcher (this is still not working very well)
#+begin_src emacs-lisp
